...
data = {"city": {"value": city, "color": get_random_color()}, "weather": {"value": wea, "color": get_random_color()},
        "temperature": {"value": temperature, "color": get_random_color()},
        "low": {"value": low, "color": get_random_color()}, "high": {"value": high, "color": get_random_color()},
        "wind": {"value": wind, "color": get_random_color()}, "air": {"value": air, "color": get_random_color()},
        "pig_city": {"value": pig_city, "color": get_random_color()},
        "pig_weather": {"value": pig_wea, "color": get_random_color()},
        "pig_temperature": {"value": pig_temperature, "color": get_random_color()},
        "pig_low": {"value": pig_low, "color": get_random_color()},
        "pig_high": {"value": pig_high, "color": get_random_color()},
        "pig_wind": {"value": pig_wind, "color": get_random_color()},
        "pig_air": {"value": pig_air, "color": get_random_color()},
